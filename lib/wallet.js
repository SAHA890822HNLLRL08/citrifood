...
export function paymentEligibility(wallet,order){
 ...
 return cashOrderEligibility({currentCashDebtCents:wallet.amountToDepositCents,orderCashTotalCents:order.totalCents,courierEarningCents:order.courierEarningCents||0});
}
