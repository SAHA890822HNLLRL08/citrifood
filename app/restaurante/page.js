...
export default function Restaurante(){
 ...
 const change=(o,status)=>{if(o.demo)setExamples(v=>v.map(x=>x.id===o.id?{...x,status}:x));else updateOrder(o.id,{status})};
