...
export default function OrderChat({order,role}){
 ...
 return <section className="orderChat" aria-label="Mensajes del pedido">
  ...
  <p>Comunicación durante la entrega sin mostrar teléfonos. Estos mensajes solo funcionan en pestañas del mismo navegador; todavía no hay llamadas, notificaciones ni chat entre teléfonos.</p>
